...
public class AccommodationService
{
    ...
    public ApiResponse<AccommodationResponse> createAccommodation(@NonNull Integer routeId,@NonNull AccommodationRequest req)
    {
        ...
        boolean existsByRouteAndLatitudeAndLongitude = accommodationRepo.existsByRoute_IdAndLongitudeAndLatitude(route.getId(),req.getLongitude(),req.getLatitude());
        if(existsByRouteAndLatitudeAndLongitude) throw new DuplicateResourceFoundException("accommodation","route id , longitude and latitude",String.format("%d , %f and %f",route.getId(),req.getLongitude(),req.getLatitude()));
